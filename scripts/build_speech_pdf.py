...
story += page("왜 지금 이 사업에 집중해야 하는가", "01 · market case", ["시장성은 원료를 많이 파는 데서 끝나지 않습니다. 규격이 반복되고, 현장 성과가 측정되며, 그 결과가 재구매로 이어지는 구조가 시장성을 만듭니다.", "OECD·FAO는 축산 생산과 사료 수요, 사료 효율 개선을 함께 전망하고 있습니다. FAO도 사료·영양 혁신을 생산성 향상과 메탄 저감의 주요 경로로 제시합니다.", "출처: OECD-FAO Agricultural Outlook 2024-2033 · FAO Enteric Methane. 본 사업의 성과는 별도 축종 시험으로 확인합니다."], [["집중 이유", "가바크루드 20% 표준품", "로트·CoA·OEM 농도·원가를 표준화해 고객 배합사료로 확장"], ["도입 효과", "가바케어믹스", "스트레스·사료효율·증체·출하시기·폐사·육질·메탄을 시험으로 확인"], ["투자 판단", "증빙 연결", "원료 규격 → 시험성적 → 반복 주문으로 이어지는 단계적 확장"]])+[PageBreak()]
...
story += page("가바케어믹스의 검증 설계", "04 · care mix", ["가바케어믹스는 가축 1마리당 1회 GABA 50~100mg을 제공하도록 설계합니다. GABA 20% 가바크루드를 기준으로 제품 0.25~0.50g을 사용하면 목표량을 충족합니다.", "원료 2종만 반영한 이론 원가는 약 3,000.25~3,000.50원/kg입니다: 가바크루드 0.25~0.50g×4,000원/kg + 미네랄매트릭스 잔량×3,000원/kg. 제조·검사·포장·수율손실은 별도 반영합니다.", "기대효과: 축종별 생산주기에 맞춘 브랜드 축산 솔루션, 생산성·사료효율·축산물 품질을 함께 관리하는 시험 프레임, 농장 데이터와 연구기관 검증을 연결하는 재구매 판단 구조.", "시험 확인 필요: 스트레스 지표, 사료 효율·증체율, 출하 시기 단축, 폐사량, 육질, 메탄가스 배출량."], [["축종군", "관찰기간 기준", "핵심 지표"], ["비육우", "168일 이상", "일당증체량·사료요구율·도체성적"], ["젖소", "84일 이상", "산유량·유성분·건물섭취량"], ["돼지·육계·산란계", "42~168일", "증체·사료요구율·출하·산란 지표"]])+[PageBreak()]
