...
story += page("가바크루드 기준 규격", "03 · crude", ["GABA 20%를 기준으로 설계한 원료입니다. 실제 출하 규격은 로트별 CoA, 안정성, 건조 수율과 품목 분류 확인 후 확정합니다.", "기대효과: 규격이 선명한 원료 선택, 농도별 OEM 대응, 로트·CoA 기반 구매 검토. 효능이 아닌 구매·공급 편의에 대한 마케팅 표현입니다."], [["항목", "기준", "검증 조건"], ["GABA 함량", "20% (w/w)", "로트별 공인시험 또는 CoA"], ["OEM 범위", "5~20%", "고객 발주서와 생산 배치기록"], ["원가", "배양액 생산원가 400만원/톤 기준", "실제 수율·건조·검사·포장 견적"]])+[PageBreak()]
story += page("가바케어믹스의 검증 설계", "04 · care mix", ["가바케어믹스는 동일한 제품 가정으로 축종별 대조군을 운영하고, 생산주기 종료 시점에 최종 성과를 판정합니다.", "기대효과: 축종별 생산주기에 맞춘 브랜드 축산 솔루션, 생산성·사료효율·축산물 품질을 함께 관리하는 시험 프레임, 농장 데이터와 연구기관 검증을 연결하는 재구매 판단 구조."], [["축종군", "관찰기간 기준", "핵심 지표"], ["비육우", "168일 이상", "일당증체량·사료요구율·도체성적"], ["젖소", "84일 이상", "산유량·유성분·건물섭취량"], ["돼지·육계·산란계", "42~168일", "증체·사료요구율·출하·산란 지표"]])+[PageBreak()]
