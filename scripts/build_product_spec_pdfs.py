...
make(ROOT/"GABA_Caremix_Specification_v1.pdf", "가바케어믹스 사양서", "가바케어믹스는 가바크루드와 미네랄매트릭스를 조합한 축종별 배합사료 설계안입니다.", [["GABA 설계량","제품 1kg당 100mg","축종별 실제 섭취량 시험"],["구성 원가","7,000원/kg","가바크루드 4,000원 + 미네랄매트릭스 3,000원"],["적용 축종","소·돼지·육계·산란계·염소·면양","대조군 시험·생산주기 종료 판정"]], ["100mg/제품kg은 사용자 제공 설계값이며, 실제 유효용량과 급여량은 축종별 시험과 연구기관 검토 후 확정합니다.", "스트레스, 사료효율, 증체율, 출하시기, 폐사량, 육질, 메탄가스 저감은 모두 기대 방향이며 시험 결과로 확인합니다."])
