...
make(ROOT/"GABA_Caremix_Specification_v1.pdf", "가바케어믹스 사양서", "가바케어믹스는 가바크루드와 미네랄매트릭스를 조합해 사료 1톤당 1kg을 투입하는 배합사료 설계안입니다.", [["최종 사료 GABA 설계량","100mg/kg 사료","사료 1톤에 GABA 100g 제공"],["혼합비","가바크루드 50% + 미네랄매트릭스 50%","가바크루드 GABA 20% 기준으로 가바케어믹스 GABA 10% 설계"],["원료 투입원가","5,000원/kg · 사료 1톤당 5,000원","가바크루드 0.5kg×7,000원 + 미네랄매트릭스 0.5kg×3,000원"],["적용 축종","비육우·젖소·돼지·육계·산란계·염소·면양","대조군 시험·생산주기 종료 판정"]], ["5,000원/kg은 원료 2종만 반영한 표준품 기준 이론값입니다. 제조·검사·포장·수율손실은 실제 견적과 시험생산 수율로 별도 반영합니다.", "반추위동물 메탄가스 저감은 별도 대조시험으로 확인하는 미래사업 검증 항목입니다. 스트레스, 사료효율, 증체율, 육질과 메탄 관련 효과는 시험 결과 전까지 확정 효능으로 표시하지 않습니다."])
