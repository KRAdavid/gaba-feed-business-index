...
class InquiryE2EStaticTests(unittest.TestCase):
    ...
    def test_read_only_installation_verifier_covers_all_operating_sheets(self):
        self.assertIn("function verifyGabaInquiryReceiverV2()", self.apps_script)
        self.assertIn("GABA_INQUIRY_HEADERS_V2", self.apps_script)
        self.assertIn("GABA_LEAD_HEADERS_V2", self.apps_script)
        self.assertIn("GABA_KPI_HEADERS_V2", self.apps_script)
        self.assertIn("sync_token_configured", self.apps_script)
