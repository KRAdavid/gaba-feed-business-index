...
- **가바케어믹스:** 가바크루드와 미네랄매트릭스를 조합해 비육 한우의 육질과 생산성을 검증하는 브랜드 축산용 배합사료 사업

두 사업은 판매 대상과 수익 구조가 다르지만, 규제 검토·성분 분석·로트 품질·공급 조건·고객 시험은 같은 기준으로 관리합니다.

가바케어믹스는 30일 안에 제품 규격, 시험생산, 실제 원가와 유료 농장 실증을 준비합니다. 90일에는 생산성 조기 신호를 확인하고, 육질은 개체 식별이 연결된 출하 성적으로 최종 판단합니다. 30일 목표는 효능 확정이 아니라 검증 가능한 사업의 착수입니다.
...
- `GABA_Index_Master.xlsx`: 준비도, 근거 자료, 손익 가정, 가바케어믹스 검증 KPI, 핵심 인력, 생산 파트너를 관리하는 원본
